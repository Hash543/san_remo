		...
		return function (config) {
	        ...
	        $(document).ready(function() {
	            ...
	            function initialize(response) {
	                ...
	                function bindInfoWindow(marker, map, infowindow, name, address, city, postcode, telephone, link, external_link, email, schedule) {
	                    google.maps.event.addListener(marker, 'click', function() {
							...
							if (schedule) {
								contentString += '<p class="stockists-schedule">'+schedule.replace(/\n/g, "<br />")+'</p>';
							}
							// if (external_link) {
							...
							// } else if (link) {
							// 	contentString += '<p class="stockists-telephone"><a href="/'+config.moduleUrl+'/'+link+'" target="_blank">Ver tienda</a></p>'
							// }
	                        /*contentString += '<p class="ask-for-directions get-directions" data-directions="DRIVING">Ver tienda</p>';*/
	                        contentString += '</div>';
	                ...
	                for (var i = 0; i < length; i++) {
	                    ...
	                    bindInfoWindow(marker, map, infowindow, data.name, data.address, data.city, data.postcode, data.phone, data.link, data.external_link, data.email, data.schedule);
