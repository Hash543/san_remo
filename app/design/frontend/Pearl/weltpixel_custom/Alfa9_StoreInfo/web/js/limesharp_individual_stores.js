				...
				function initialize() {
					...
					function bindInfoWindow(marker, map, infowindow, name, address, city, postcode, telephone, link, external_link, email) {
						google.maps.event.addListener(marker, 'click', function() {
							...
							// }
							/*contentString += '<p class="ask-for-directions get-directions" data-directions="DRIVING"><a href="http://maps.google.com/maps?saddr=&daddr='+marker.getPosition().lat()+','+marker.getPosition().lng()+'" target="_blank">Ver tienda</a></p>';*/
							contentString += '</div>';
