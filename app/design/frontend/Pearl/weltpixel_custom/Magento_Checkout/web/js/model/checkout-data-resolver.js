    ...
    return {
        ...
        resolveShippingRates: function (ratesData) {
            ...
            if (ratesData.length === 1 && !quote.shippingMethod()) {
                ...
                return;
            } else if(selectedShippingRate == null && ratesData.length > 1 && !quote.shippingMethod()){
                for(var i in ratesData) {
                    const rate = ratesData[i];
                    // Choose by default the shipping method of flat rate
                    if(rate.carrier_code === 'amstrates') {
        ...
        applyBillingAddress: function () {
            var shippingAddress;
            /*var isBillingAddressInitialized = addressList.some(function (addressFromList) {
