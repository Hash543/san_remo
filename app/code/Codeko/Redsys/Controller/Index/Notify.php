...
class Notify extends \Codeko\Redsys\Controller\Index
{
    ...
    public function execute()
    {
        ...
        if (!empty($params_request)) {
            ...
            //if(strlen($order_id) == 12 && preg_match(/^000/,$order_id)){
            ...
            $this->getHelper()->log($id_log . " - " . "Pedido: " . $order_id . " Transacción: " . $id_trans . " - " . $fecha . " " . $hora);
            ...
            if ($validate === true) {
                ...
                if ($respuesta < 101) {
                    ...
                    if ($amountOrig != $total) {
                        ...
                        $this->getHelper()->log($id_log . " - " . "Importe Original: ". $amountOrig);
                        $this->getHelper()->log($id_log . " - " . "Importe Total: ". $total);
                    ...
                    try {
                        ...
                        $this->_eventManager->dispatch('accepted_payment_redsys', ['order' => $order]);
