...
class AttributeMerger
{
    ...
    public function aroundMerge(
        ...
        $isVatEnabled = (bool)$this->scopeConfig->getValue(\Magento\Customer\Helper\Address::XML_PATH_VAT_FRONTEND_VISIBILITY,
            ScopeInterface::SCOPE_STORE );
        foreach ($elements as $attributeCode => &$attributeConfig) {
            ...
            if (isset($fieldConfig[$attributeCode])) {
                ...
                //Fix to show Vat
                if ((!(int)$field->getData('enabled') && $attributeCode != 'vat_id') || ($attributeCode == 'vat_id' && !$isVatEnabled)) {
