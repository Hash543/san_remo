...
class Information extends \Magento\Config\Block\System\Config\Form\Fieldset
{
     ...
     * @var string
     */
    private $userGuideLink = 'https://amasty.com/docs/doku.php?id=magento_2%3Ashipping_table_rates&utm_source=extension&utm_medium=link&utm_campaign=str-m2-guide';
    ...
    {
        $moduleInfo = $this->moduleHelper->getModuleInfo("Amasty_ShippingTableRates");
     ...
     * @return bool
     */
    private function isLastVersion($currentVer, $moduleCode = 'Amasty_ShippingTableRates')
    {
        $result = true;
        $allExtensions = $this->moduleHelper->getAllExtensions();
        if ($allExtensions && isset($allExtensions[$moduleCode])) {
            $module = $allExtensions[$moduleCode];
     ...
     * @return string
     */
    private function getLogoHtml($moduleCode = 'Amasty_ShippingTableRates')
    {
        $src = $this->_assetRepo->getUrl("Amasty_Base::images/amasty_logo.svg");
        $href = 'https://amasty.com' . $this->getSeoparams() . 'amasty_logo_' . $moduleCode;
