...
abstract class Blacklist extends \Magento\Backend\App\Action
{
    ...
    {
        return $this->_authorization->isAllowed('Amasty_Acart::acart_blacklist');
    }
    ...
    protected function initCurrentBlacklist($blacklist)
    {
        $this->_coreRegistry->register(RegistryConstants::CURRENT_AMASTY_ACART_BLACKLIST, $blacklist);
