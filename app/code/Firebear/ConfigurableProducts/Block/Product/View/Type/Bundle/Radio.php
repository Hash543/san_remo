...
{
    protected $_template = 'product/view/type/bundle/options/radio.phtml';
    protected $_template_swatch = 'product/view/type/bundle/options/radio_swatch.phtml';
    protected $defaultTemplate = 'Magento_Bundle::catalog/product/view/type/bundle/option/radio.phtml';
