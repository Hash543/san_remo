...
namespace Alfa9\StoreInfo\Model\ResourceModel;
...
class Stores extends AbstractDb
{
    ...
    {
        $this->_init('alfa9_storeinfo_store', 'storeinfo_id');
    }
    ...
    {
        $condition = ['storeinfo_id = ?' => (int)$object->getId()];
        $this->getConnection()->delete($this->getTable('alfa9_storeinfo_store'), $condition);
     ...
     *
     * @param AbstractModel|\Alfa9\StoreInfo\Model\Stores $object
     * @return $this
     */
