...
class Uploader
{
     ...
     * @var string
     */
    const IMAGE_TMP_PATH    = 'storeinfo/tmp/stockist/image';
    /**
     * @var string
     */
    const IMAGE_PATH        = 'storeinfo/stockist/image';
    /**
     * @var string
     */
    const FILE_TMP_PATH     = 'storeinfo/tmp/stockist/file';
    /**
     * @var string
     */
    const FILE_PATH         = 'storeinfo/stockist/file';
