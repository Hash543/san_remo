...
abstract class Action extends DataObject implements ActionInterface
{
    ...
    {
        $pointAmount = $this->getActionObject()->getData('point_amount');
        if (!$pointAmount) {
    ...
    /**
     * @param \Mageplaza\RewardPoints\Model\Transaction $transaction
     * @param $comment
     *
    ...
    public function getStoreId()
    {
        ...
        return $actionObject->getData('store_id') ?: $customer->getStoreId();
    }
