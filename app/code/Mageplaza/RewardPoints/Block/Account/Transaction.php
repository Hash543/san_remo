...
/**
 * Class Transaction
 * @method \Mageplaza\RewardPoints\Model\ResourceModel\Transaction\Collection getTransactions()
...
class Transaction extends Dashboard
{
    ...
    /**
     * @var \Mageplaza\RewardPoints\Model\TransactionFactory
     */
    ...
    protected function _prepareLayout()
    {
        ...
        if ($this->getTransactions()) {
            $pager = $this->getLayout()->createBlock('Magento\Theme\Block\Html\Pager', 'mpreward.transactions.pager')
