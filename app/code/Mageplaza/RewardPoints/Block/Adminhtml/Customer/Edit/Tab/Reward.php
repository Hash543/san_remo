...
class Reward extends Generic implements TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $historyFieldset->addField(
            'reward_transaction',
            'Mageplaza\RewardPoints\Block\Adminhtml\Render\Customer\History',
            [
                'transaction_history' => $this->getLayout()
                    ->createBlock(\Mageplaza\RewardPoints\Block\Adminhtml\Customer\Edit\Tab\Grid\History::class)->toHtml()
            ]
        );
