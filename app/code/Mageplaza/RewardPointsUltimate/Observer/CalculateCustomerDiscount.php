            ...
            if (in_array(
                ...
                if ($discountAmount) {
                    ...
                    if ($rule->getCustomerApplyToShipping()) {
                        ...
                        $quote->setMpRewardShippingInvitedBaseDiscount($quote->getMpRewardShippingInvitedBaseDiscount() + $baseShippingDiscount);
                        $quote->setMpRewardShippingBaseDiscount($quote->getMpRewardShippingBaseDiscount() + $baseShippingDiscount)
                        ...
                        $discount = $this->calculation->convertPrice($baseDiscount, false, false, $quote->getStoreId());
