...
abstract class AbstractRules extends Action
{
    ...
    /**
     * @var \Mageplaza\RewardPointsPro\Model\ShoppingCartEarningRuleFactory
     */
    ...
    /**
     * @return \Mageplaza\RewardPointsPro\Model\CatalogRule|
    ...
    public function saveShoppingCartRule()
    {
        if ($this->getRequest()->getPostValue()) {
            ...
            try {
                ...
                if ($validateResult == 1
                    && $validateData->getRuleType() == Type::SHOPPING_CART_SPENDING
