    ...
    function collect($productId, $value, $strategy, $profile)
    {
        ...
        if ($entityTypeIsValid && empty($value) == false) {
            ...
            foreach ($skus as $sku) {
                ...
                $this->queries[$this->queryIndexer][] = "INSERT INTO " . $this->tableCplai . " (product_link_attribute_id,link_id,value) VALUES(" . $productLinkAttributeId . ",LAST_INSERT_ID(),$position)";
                $position++;
            }
        }
