...
//        ),
     ...
     * @var null
     */
    protected $_increment = null;
    /**
     * @var null
     */
    protected $_sequenceIncrement = null;
    /**
     ...
     * @var bool
     */
    protected $_rootCategoryId = false;
    /**
     * @var array
     */
    protected $_categoryProductPosition = [];
    /**
     * @var array
     */
    protected $_storeRootIds = [];
    ...
    {
        return [3 => "catalog_category_product", 4 => "catalog_product_category"];
    }
        ...
        if (trim($value) != "") {
            ...
            foreach ($values as $value) {
                ...
                if ($profile->getTreeDetection() == false) {
                    ...
                    $data = $this->_helperData->prepareFields(["position" => 0], $value, "position");
                    $position = $data["position"];
                    $value = $this->_helperData->getValue($value);
                    ...
                    if (count($values)) {
                        ...
                        foreach ($values as $value) {
                            ...
                            $parameter = $this->_helperData->prepareFields(["position" => 0], $value, "position");
...
//                        }
    ...
    )
    {
        ...
        if ($this->_coreHelper->moduleIsEnabled("Magento_Enterprise")) {
            ...
            $this->queries[$this->queryIndexer][] = "INSERT INTO `$this->tableEntity` (entity_id,attribute_set_id,parent_id,created_at,updated_at,created_in,updated_in)"
                . "VALUES(@sequence_id,$this->categoryEntityTypeId,$parentId,'" . date("Y-m-d H:i:s") . "','" . date("Y-m-d H:i:s") . "','1','" . time() . "');";
            ...
            $this->queries[$this->queryIndexer][] = "INSERT INTO `$this->tableEntity` (entity_id,attribute_set_id,parent_id,created_at,updated_at)"
                . "VALUES(NULL,$this->categoryEntityTypeId,$parentId,'" . date("Y-m-d H:i:s") . "','" . date("Y-m-d H:i:s") . "');";
        ...
        foreach (self::ATTRIBUTES as $key => $attribute) {
            ...
            switch ($key) {
                ...
                case "include_in_menu":
                    ...
                    break;
                case "url_key":
                    $val = $this->_filterManager->create()->translitUrl($value . "-" . rand(1, 99));
                    break;
                case "url_path":
                    $val = "url_path";
                    break;
    ...
    function getFields($fieldset = null, $form = null, $class = null)
    {
        ...
        $fieldset->addField('create_category_onthefly', 'select', [
        ...
        $fieldset->addField('category_is_active', 'select', [
        ...
        $fieldset->addField('category_include_in_menu', 'select', [
        ...
        $fieldset->addField('tree_detection', 'select', [
            'name' => 'tree_detection',
        ...
        $fieldset->addField('category_parent_id', 'select', [
     ...
     * @throws \Magento\Framework\Exception\NoSuchEntityException
     */
    private function getCategories($category = false, $dropdown = true, $field = null)
    {
