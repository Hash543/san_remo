...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
     ...
     *
     */
    const POST_PROCESS_INDEXERS_ENABLED = 1;
    /**
     *
     */
    ...
    /**
     * @var null|\Wyomind\MassStockUpdate\Logger\Logger
     */
...
// Find the position of the unit in the ordered string which is the power of magnitude to multiply a kilobyte by.
     ...
     */
    public
    function getData($file, $params, $limit = INF, $isOutput = false)
    {
        try {
            $data = array();
                            ...
                            foreach ($structure as $header => $xpath) {
                                ...
                                if (isset($result[0])) {
                                    ...
                                    if (count($result[0]) != 0) {
                                        ...
                                        $cell[$x] = json_encode($result[0], JSON_PRETTY_PRINT);
                                    }
...
// attribute is mapped with a custom value
     ...
     */
    public
    function execPhp($script, &$cell = null, $self = null)
    {
     ...
     */
    public
    function getLineRangeCondition($parameters, $lineNumber, $identifier, $cell = [])
    {
        $upTo = false;
        $range = false;
        $equal = false;
