...
class Stock {
    ...
    /**
     * @param \Magento\ProductAlert\Controller\Unsubscribe\Stock $subject
     * @param \Closure $proceed
     * @param RequestInterface $request
     * @return \Magento\Framework\Controller\ResultInterface
     */
    public function aroundDispatch(
        \Magento\ProductAlert\Controller\Unsubscribe\Stock $subject,
        \Closure $proceed,
        ...
        $email = urldecode($this->request->getParam('email'));
