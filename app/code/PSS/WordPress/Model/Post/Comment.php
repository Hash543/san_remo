 ...
 */
namespace PSS\WordPress\Model\Post;

class Comment extends \PSS\WordPress\Model\Meta\AbstractMeta
{
	...
	{
		$this->_init('PSS\WordPress\Model\ResourceModel\Post\Comment');
