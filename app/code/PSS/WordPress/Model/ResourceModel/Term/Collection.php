 ...
 */
namespace PSS\WordPress\Model\ResourceModel\Term;

class Collection extends \PSS\WordPress\Model\ResourceModel\Collection\AbstractCollection
{
    /**
    ...
    {
        $this->_init('PSS\WordPress\Model\Term', 'PSS\WordPress\Model\ResourceModel\Term');
    }
     ...
     *
     * @param int|\PSS\WordPress\Model\Term
     * @return $this
     */
