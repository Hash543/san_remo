...
/* Parent Class */
use PSS\WordPress\Model\ResourceModel\Meta\AbstractMeta;

/* Constructor Args */
use Magento\Framework\Model\ResourceModel\Db\Context;
use PSS\WordPress\Model\Context as WPContext;
use PSS\WordPress\Model\PostTypeManager;
use PSS\WordPress\Model\TaxonomyManager;
...
#						$permalinks += $buffer;
	 ...
	 * @return bool
	 */
	public function hasChildrenPosts(\PSS\WordPress\Model\Post $post)
	{
		$select = $this->getConnection()
			->select()
...
/**
	 ...
	 */
	public function getPostComments(\PSS\WordPress\Model\Post $post)
	{
		return $this->factory->create('PSS\WordPress\Model\ResourceModel\Post\Comment\Collection')
			->setPost($post)
	 ...
	 *
	 * @param \PSS\WordPress\Model\Post $post
	 * @return \PSS\WordPress\Model\Image $image
	 */
	public function getFeaturedImage(\PSS\WordPress\Model\Post $post)
	{
	...
	{
		$collection = $this->factory->create('PSS\WordPress\Model\ResourceModel\Post\Comment\Collection')
