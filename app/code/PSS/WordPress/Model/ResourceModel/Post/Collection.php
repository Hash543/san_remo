 ...
 */
namespace PSS\WordPress\Model\ResourceModel\Post;

/* Parent Class */
use PSS\WordPress\Model\ResourceModel\Meta\Collection\AbstractCollection as AbstractMetaCollection;
...
class Collection extends AbstractMetaCollection
{
	...
	{
    $this->_init('PSS\WordPress\Model\Post', 'PSS\WordPress\Model\ResourceModel\Post');
  ...
  protected function _initSelect()
  {
	...
	protected function _beforeLoad()
	{
		...
		if (!$this->hasPostTypeFilter()) {
			if ($this->getFlag('source') instanceof \PSS\WordPress\Model\Term) {
