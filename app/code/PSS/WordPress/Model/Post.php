...
class Post extends AbstractMeta implements ViewableInterface
{
   ...
   */
	...
	{
		$this->_init('PSS\WordPress\Model\ResourceModel\Post');
	...
	{
		return $this->factory->create('PSS\WordPress\Model\ResourceModel\Term\Collection')
	 ...
	 *
	 * @return false|\PSS\WordPress\Model\Post
	 */
	 ...
	 * 
	 * @return \PSS\WordPress\Model\ResourceModel\Image\Collection
	 *
	...
	/*
	 *
	 * @return \PSS\WordPress\Model\Homepage
	 */
