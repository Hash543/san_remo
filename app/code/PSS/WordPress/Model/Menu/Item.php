 ...
 */
namespace PSS\WordPress\Model\Menu;
...
class Item extends Post
{
	...
	**/
	...
	{
        $this->_init('PSS\WordPress\Model\ResourceModel\Menu\Item');
	}
	 ...
	 *
	 * @return false|\PSS\WordPress\Model\AbstractModel
	 */
			...
			if ($this->getObjectType()) {
				if ($menuObjectId = $this->getMetaValue('_menu_item_object_id')) {
					if ($this->isPostTypeLink())  {
						...
						$object = $this->factory->create('PSS\WordPress\Model\\' . ucwords($this->getObjectType()));
					}
	 ...
	 *
	 * @return \PSS\WordPress\Model\ResourceModel\Menu\Item\Collection
	 */
