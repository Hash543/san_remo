...
abstract class PostEntity extends \Magento\Framework\View\Element\Template {
     ...
     * @return int|null
     */
    public abstract function getAssociationTypeId();
    ...
    public function getPostList() {
        ...
        if ($entityId !== null && $associationTypeId !== null) {
            $postIds = $this->dataHelper->getPostIdsRelated($associationTypeId, $entityId);
            if (count($postIds) > 0 ){
