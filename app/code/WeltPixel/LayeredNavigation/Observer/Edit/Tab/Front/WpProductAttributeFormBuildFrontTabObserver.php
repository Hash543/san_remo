    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        $fieldset->addField(
            ...
            [
                ...
                'note' => __('[Closed] option not applicable on [Slide Down] Sidebar Style.<br/> Can be used only with catalog input type Dropdown, Multiple Select and Price. %1', $swatchComment),
                'values' => [
        ...
        $fieldset->addField(
            ...
            [
                ...
                'note' => __('Allow to filter multiple options from the same attribute. %1', $swatchComment)
