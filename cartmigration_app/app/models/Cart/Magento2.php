...
class LECM_Model_Cart_Magento2
    ...
    public function displayImportSource()
    {
        ...
        $count    = $this->getConnectorData($this->getConnectorUrl('query'), array(
            ...
            'query'     => serialize(array(
                'taxes'         => array(
                    'type'  => 'select',
                    'query' => "SELECT COUNT(1) AS count FROM _DBPRF_tax_class WHERE class_type = 'PRODUCT' ",
                ),
                'manufacturers' => array(
                    'type'  => 'select',
                ...
                'categories'    => array(
                    'type'  => 'select',
                    'query' => "SELECT COUNT(1) AS count FROM _DBPRF_catalog_category_entity WHERE level > 1 ",
                ),
                'products'      => array(
                    'type'  => 'select',
                    'query' => "SELECT COUNT(1) as count FROM _DBPRF_catalog_product_entity 
                ...
                'customers'     => array(
                    'type'  => 'select',
                    'query' => "SELECT COUNT(1) AS count FROM _DBPRF_customer_entity ",
                ),
                'orders'        => array(
                    'type'  => 'select',
                    'query' => "SELECT COUNT(1) AS count FROM _DBPRF_sales_order ",
                ),
                'reviews'       => array(
                    'type'  => 'select',
                    'query' => "SELECT COUNT(1) AS count FROM _DBPRF_review ",
                ),
                'pages'         => array(
                    'type'  => 'select',
                    'query' => "SELECT COUNT(1) AS count FROM _DBPRF_cms_page ",
                ),
                'blocks'        => array(
                    'type'  => 'select',
                    'query' => "SELECT COUNT(1) AS count FROM _DBPRF_cms_block ",
                ),
                'transactions'  => array(
                    'type'  => 'select',
                    'query' => "SELECT COUNT(1) AS count FROM _DBPRF_core_email_template ",
                ),
                'rules'         => array(
                    'type'  => 'select',
                    'query' => "SELECT COUNT(1) AS count FROM _DBPRF_salesrule ",
                ),
                'cartrules'     => array(
                    'type'  => 'select',
                    'query' => "SELECT COUNT(1) AS count FROM _DBPRF_catalogrule ",
                ),
...
//        }
    ...
    {
        return $this->getMapFieldBySource(self::TYPE_MANUFACTURER, $convert['id']) ? true : false;
    }
    ...
    {
//        $this->updateSeoCate($category,$categoriesExt,$convert);
//        return true;
        return $this->getMapFieldBySource(self::TYPE_CATEGORY, $convert['id']) ? true : false;
    }
...
//            }
    ...
    {
//        $this->updateSeoPrd($product,$productsExt,$convert);
//        return true;
        return $this->getMapFieldBySource(self::TYPE_PRODUCT, $convert['id']) ? true : false;
    }
        ...
        if (isset($convert['bundle_option'])) {
            ...
            foreach ($convert['bundle_option'] as $key_option => $values_option) {
                ...
                foreach ($values_option['value'] as $key_value => $value_values) {
                    ...
                    if (Bootstrap::getConfig('dev_mode')) {
                        $catalog_product_bundle_option_value_import = $this->importProductData();
                ...
                if ($value['frontend_input'] == 'multiselect' || $value['frontend_input'] == 'select') {
                    if (isset($value['option_data'])) {
                        foreach ($value['option_data'] as $key1 => $item) {
                            ...
                            $eav_attribute_option_value_query = $this->createInsertQuery('eav_attribute_option_value',$eav_attribute_option_value_data);
                            $this->importProductData($eav_attribute_option_value_query);
...
//            var_dump();exit;
    ...
    {
        return $this->getMapFieldBySource(self::TYPE_CUSTOMER, $convert['id']);
    }
...
//      -------------------------------------------------------------------------------------------
    ...
    public function convertReviewExport($review, $reviewsExt)
    {
        ...
        if ($review_detail) {
            ...
            $review_data['detail_store']          = $review_detail['store_id'];
    ...
    {
        return $this->getMapFieldBySource(self::TYPE_REVIEW, $convert['id']) ? true : false;
    }
...
//        $this->insertMap($url_src, $url_desc, self::TYPE_ATTR, $item['attribute_id'], $attribute_id, $item['attribute_code']);
    ...
    public function checkOptionExists($option_value, $attribute_code)
    {
        ...
        if (isset($eav_attribute_option_value['data'][0]['option_id'])) {
                return $eav_attribute_option_value['data'][0]['option_id'];
        }
...
//        print_r($type);exit;
    ...
    //code Magento end
    function updateSeoCate($category,$categoriesExt,$convert){
